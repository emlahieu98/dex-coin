...
export default function DetailInfo({
        ...
        <>
          <DivTitle>
            ...
            <Tooltip
              ...
              title={
                currentUser?.roles?.includes('admin_chief_accountant')
                  ? 'Kế toán trưởng duyệt yêu cầu rút tiền. (Nếu kế toán viên chưa duyệt, Kế toán trưởng có thể duyệt cả 2 bước.)'
                  : currentUser?.roles?.includes('admin_accountant')
                  ? 'Kế toán viên duyệt yêu cầu rút tiền. (Kế toán trưởng cũng có thể duyệt bước này)'
                  : ''
              }
            >
  ...
  //       <Tooltip
  //         placement="right"
  //         title="Kế toán viên duyệt yêu cầu rút tiền. (Kế toán trưởng cũng có thể duyệt bước này)"
  //       >
  //         <img className="tooltip" src={tooltip} alt="" />
  //       </Tooltip>
  //     </DivTitle>
  ...
  //       <Tooltip
  //         placement="right"
  //         title="Kế toán trưởng duyệt yêu cầu rút tiền. (Nếu kế toán viên chưa duyệt, Kế toán trưởng có thể duyệt cả 2 bước.)"
  //       >
  //         <img className="tooltip" src={tooltip} alt="" />
  //       </Tooltip>
  //     </DivTitle>
