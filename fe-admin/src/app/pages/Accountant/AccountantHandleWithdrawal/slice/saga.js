...
import { AccountantHandleWithdrawalActions as actions } from '.';
...
export function* getData({ payload }) {
  yield delay(500);
  const requestURL = `${USER_SERVICE}admin/transactions${payload}&transaction_type=withdrawal`;
  try {
...
export function* AccountantHandleWithdrawalSaga() {
